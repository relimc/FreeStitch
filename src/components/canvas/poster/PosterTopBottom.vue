<template>
    <div class="poster-top-bottom" :style="{ gap: spacing + 'px' }">
        ...
        <div class="poster-bottom-group" :style="{ gap: spacing + 'px' }">
            <div v-for="idx in [1, 2]" :key="idx" class="poster-bottom"
...
.poster-top img, .poster-bottom img {
    width: 100%;
    height: 100%;
    object-fit: cover;
}
